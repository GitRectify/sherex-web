        ...
        <div className="flex justify-center w-full">
            {poolsLoading || !pool ?
                ...
                (<div className="pt-28 pb-40 px-4 lg:px-10 min-[1390px]:px-0  flex flex-col relative w-full xl:w-[1290px]">
                    ...
                    <div
                        className="pt-28 pb-40 flex justify-center items-center relative h-full"

                    >
                        {/* Home header */}
                        <div className="flex flex-col justify-start items-start p-10  lg:w-[600px] w-full text-white sm:px-10 px-4 rounded-2xl relative overflow-hidden border border-[#F3BA2F] border-opacity-40 backdrop-blur-[20px] bg-gradient-to-br from-white/30 to-black/50">
